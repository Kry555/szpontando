    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{ label: 'Liczba nowych ogłoszeń', data: data.map(row => row.aggregate), borderColor: '#007bff', backgroundColor: 'rgba(0, 123, 255, 0.1)', borderWidth: 2, fill: true, tension: 0.3 }]
            },
