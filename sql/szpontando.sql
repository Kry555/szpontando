...
--
-- Host: localhost:3306
-- Generation Time: Apr 26, 2026 at 08:04 PM
...
--
ALTER TABLE `oceny`
  MODIFY `id_oceny` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `oferty`
--
ALTER TABLE `oferty`
  MODIFY `id_oferty` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `powiadomienia`
--
ALTER TABLE `powiadomienia`
  MODIFY `id_powiadomienia` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
