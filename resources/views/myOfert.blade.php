...
<body>
  ...
  <div class="twoje_ofert">
    ...
    <div class="oferta">
      ...
      <form method="POST" action="{{ route('zakonczOfert.post') }}">
        ...
        <button type="submit" class="zakoncz-btn" @if($oferta->status == 'anulowane' || $oferta->status == 'zbanowana')disabled @endif>
          Zakończ ofertę
        </button>
      </form>
    </div>
  ...
  <div class="zgloszenia_do_twoich">
  ...
  <div id="modal_profil_standard" class="modal">
    <div class="modal-content">
      ...
      <button type="button" onclick="closeModal_profil()" class="zaknij_but">Zamknij</button>
    </div>
  </div>

  <!-- MODAL SZCZEGÓŁY ZLECENIA -->
  <div id="modal_history_detail" class="modal">
  ...
  <div id="modal_oferta" class="modal">
    <div class="modal_content">
      ...
      <button type="button" onclick="closeModal_oferta()" class="zaknij_but">Zamknij</button>
    </div>
  </div>

  <!-- MODAL EDYCJA OFERTY -->
  <div id="modal_edit_offer" class="modal">
    <div class="modal_content">
      <h2>Edytuj ofertę</h2>
...
<label class="clear-btn">
  ...
  <script>
    ...
    function openModal_editOffer(oferta) {
      ...
      if (oferta.zdjecie_1) {
        currentZdjecie1Display.innerHTML =
          `<p>Aktualne zdjęcie 1:</p>
             <img src="{{ asset('images/oferty/') }}/${oferta.zdjecie_1}"
      ...
      if (oferta.zdjecie_2) {
        currentZdjecie2Display.innerHTML =
          `<p>Aktualne zdjęcie 2:</p>
             <img src="{{ asset('images/oferty/') }}/${oferta.zdjecie_2}"
             style="max-width: 120px; border-radius: 8px;">`;
      }

      // reset inputów file
      const file1 = document.querySelector('#modal_edit_offer input[name="zdjecie_1"]');
      const file2 = document.querySelector('#modal_edit_offer input[name="zdjecie_2"]');
