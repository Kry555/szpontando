...
<head>
  ...
  @vite('resources/css/workOfert.css')
...
<body>
  ...
  <div id="modal_history_detail" class="modal">
    <div class="modal_content">
      ...
      <h2 id="history_detail_title"></h2>

      <div id="history_detail_content"></div>

      <button onclick="closeModal_historyDetail()" class="btn_close">
        Zamknij
      </button>
  ...
  <div id="modal_oferta" class="modal">
    <div class="modal_content">
      ...
      <button onclick="closeModal_oferta()" class="btn_close">
        Zamknij
      </button>
