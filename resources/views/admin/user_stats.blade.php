  ...
  <div class="container">
    ...
    <table>
      ...
      <tbody>
        ...
        @empty
        <tr>
          <td colspan="4" style="text-align:center;">Brak użytkowników w systemie.</td>
        </tr>
        @endforelse
      </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
      ...
      <tbody>
        ...
        @empty
        <tr>
          <td colspan="4" style="text-align: center; padding: 10px;">Brak wpisów w dzienniku dla tego użytkownika.</td>
        </tr>
        @endforelse
      </tbody>
    </table>
