...
<head>
    ...
    <link rel="icon"
          href="{{ Vite::asset('resources/images/sprzontandoico.ico') }}"
          type="image/x-icon">
    ...
    <form method="GET" action="{{ route('main') }}">
        ...
        <select name="typ" id="typ">
            ...
            <optgroup label="Podstawowe">
                ...
                <option value="samochód"
                    {{ request('typ') == 'samochód' ? 'selected' : '' }}>
                    Samochód
                </option>
                ...
                <option value="cały_dom"
                    {{ request('typ') == 'cały_dom' ? 'selected' : '' }}>
                    Cały dom
                </option>
            ...
            <optgroup label="Specjalistyczne">
                ...
                <option value="brud_ciężki_przemysłowy"
                    {{ request('typ') == 'brud_ciężki_przemyslowy' ? 'selected' : '' }}>
                    Brud ciężki
                </option>
